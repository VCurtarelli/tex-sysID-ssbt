...
\begin{figure}[H]
	\centering
	\input{figures/lineplot_ERLE_case1.tex}
...
\begin{figure}[H]
	\centering
	\input{figures/lineplot_ERLE_case2.tex}
	\caption{ERLE lineplot.}
...
\begin{figure}[H]
	\centering
	\input{figures/lineplot_ERLE_case3.tex}
	\caption{ERLE lineplot.}
...
\begin{figure}[H]
	\centering
	\input{figures/lineplot_ERLE_case4.tex}
	\caption{ERLE lineplot.}
...
\begin{figure}[H]
	\centering
	\input{figures/lineplot_ERLE_case5.tex}
	\caption{ERLE lineplot.}
...
%\noindent\textit{Case 6 -} Here we will use $L = \floor{\nicefrac{N}{4}}$ (from the successful case 4) with $v[n]$ as a male speech signal.
%
%\begin{figure}[H]
%	\centering
%	\input{figures/lineplot_ERLE_case6.tex}
%	\caption{ERLE lineplot.}
%	\label{fig:sec4:lineplot_erle_case6}
%\end{figure}
%
%\noindent\textit{Case 7 -} Here we will use $L = \floor{\nicefrac{N}{4}}$ (from the successful case 4) with a Hamming window.
%
%\begin{figure}[H]
%	\centering
%	\input{figures/lineplot_ERLE_case7.tex}
%	\caption{ERLE lineplot.}
%	\label{fig:sec4:lineplot_erle_case7}
%\end{figure}